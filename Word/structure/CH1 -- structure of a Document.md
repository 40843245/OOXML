...
A newly created `*.docx` file that contains only several non-complex script characters without specific font, style, background color must contain these directories and files. Shown as following hierarchy tree.
