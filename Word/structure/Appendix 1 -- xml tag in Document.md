...
| `<c:autoTitleDeleted>` | | auto-generated deleted title | if a chart title has been manually deleted by the user, then it is automatically generated by the charting application (e.g. Excel or PowerPoint) | | |
